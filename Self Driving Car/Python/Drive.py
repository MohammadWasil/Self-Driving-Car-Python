...
#Load the model.
model = load_model('Directory/To/Load/Your/Model/YourModelName.h5') 	# Directory to load the model
...
filename = 'Directory/To/Csv/File/YourCSVFile.csv' 	#Directory to save your current Data in a csv file.
...
num = 0  
path = 'Directory/To/Save/Your/Current/Image'         # Destination/path to which all the current images will be saved 
while (True):
    num = num + 1
