...
filename = 'Directory/to/save/YOurCSVFile.csv' 		# change this directory to save your scv file.
...
path = 'Directory/to/save/images/SDC'         # Destination/path to which all the images will be saved
num = 0 
