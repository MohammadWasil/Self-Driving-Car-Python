...
def LoadData():  
    image_input_array2 = np.zeros((2116, 66, 200,3))         # Replace the value of 2116 with the number of images, you are going to train.
    URL = 'Load/Your/CSV/File/YourCSVFile.csv'		     # Load your csv file.
    
    data = p.read_csv(URL)
    
    image_input = data['Image DIrectory']
    steering_Angle = data[' Steerring Angle'].values
